...
class FraudDataset(DGLBuiltinDataset):
    ...
    file_names = {'yelp': 'YelpChi.mat', 'amazon': 'Amazon.mat', 'mimic': 'Mimic.mat'}
    node_name = {'yelp': 'review', 'amazon': 'user', 'mimic': 'Mimic'}
    ...
    def __init__(
        ...
        assert name in [
            ...
            'amazon',
            'mimic',
        ], "only supports 'yelp', 'amazon', 'mimic'"
...
class FraudMimicDataset(FraudDataset):
    ...
    def __init__(
        ...
        super(FraudMimicDataset, self).__init__(
            name='mimic',
            raw_dir=raw_dir,
            random_seed=random_seed,
            train_size=train_size,
